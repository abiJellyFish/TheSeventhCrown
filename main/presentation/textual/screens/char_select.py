...
# 魔法领域天赋选项：选择后立即启发对应领域天赋
DOMAINS = [
    {"key": "evocation", "label": "塑能领域天赋", "desc": "启发塑能领域，之后可记忆一环塑能法术"},
    {"key": "abjuration", "label": "防护领域天赋", "desc": "启发防护领域，之后可记忆一环防护法术"},
]
...
def _build_desc(char: dict) -> str:
    ...
    level = "战士 3 级" if char["class_key"] == "fighter" else "魔法使 1 级"
    parts.append(level)
    return " | ".join(parts)
